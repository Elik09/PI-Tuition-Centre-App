...
public class RComponent extends JPanel implements TuitionCenter {
    ...
    private Object[] columnName = new String [] {"Course-ID","Course-Name","Month", "Revenue","Reviews"};
    ...
    public void books(DefaultTableModel d){
        ...
        for (int i = 0; i < courses.size(); i++) {
            ...
            data[i] = new Object[]{c.getId(), c.getName(), c.getMonth(), getDetails(c.getId())[0], getDetails(c.getId())[1]};
        }
